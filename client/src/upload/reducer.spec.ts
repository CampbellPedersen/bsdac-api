...
describe('reducer', () => {
  ...
  it('given not progressing and failed message > when rap progressed > should return state with progress', () => {
  ...
  it('when rap progressed > should return state with progress', () => {
  ...
  it('given progressing > when rap uploaded > should return state with no progression', () => {
  ...
  it('given progressing > when rap upload failed > should return state with failed message', () => {
