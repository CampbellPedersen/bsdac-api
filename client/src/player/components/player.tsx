  ...
  return (
    <div className='player'>
      ...
      <div className='button'>
        <PlayerButton onClick={() => {}}>{filterIcon()}</PlayerButton>
      </div>
...
const filterIcon = (active?: boolean) => <>
  <svg fill={active ? 'black' : '#A9ABAB'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 477.875 477.875">
...
const shuffleIcon = (active?: boolean) => <>
  <svg fill={active ? 'black' : '#A9ABAB'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
